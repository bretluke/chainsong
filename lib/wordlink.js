 ...
 *
 * Two-tier stop words:
 *   HARD_STOP — always filtered (articles, pure prepositions, copulas,
 *   conjunctions, subordinators). These are never valid link words in
 *   any situation. Note that phrasal-verb particles like up/down/out/
 *   off/over/into/onto/across are deliberately NOT in this set — they
 *   carry meaning in song titles ("Level Up", "Get Down", "Off the Wall").
 *
...
const HARD_STOP = new Set([
  // articles
  'a', 'an', 'the',
  // pure prepositions (particles like up/down/into/onto/over live outside
  // this set on purpose — they're content words in song titles)
  'of', 'to', 'in', 'on', 'at', 'by', 'for', 'with', 'from',
  // copulas + linking verbs
  'as', 'is', 'be', 'am', 'are', 'was', 'were', 'been',
  // conjunctions
  'and', 'or', 'but', 'nor', 'so', 'yet',
  // subordinators + demonstratives
